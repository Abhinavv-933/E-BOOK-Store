...
import { 
   Backdrop,Box , CircularProgress,Paper, Table, TableBody,
...
export default function ViewOrders(){
   ...
   const [loading, setLoading] = useState(false);
      ...
      const formatPlacedAtData = (postedData) => {
           const data = new Date(postedData);
           const options = { day: 'numeric', month:'short' , year: 'numeric'};
           return data.toLocaleDateString('on-US', options);
      };
                        ...
                        {orders.map((row) =>(
                             <TableRow
                              ...
                              >
                                 ...
                                 <TableCell align='right'>{formatPlacedAtData(row.updatedAt)}</TableCell>
                              </TableRow>
